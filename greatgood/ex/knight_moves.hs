...
canReachIn3 start end = 'elem' end in3 start -- check whether our ending position is in the list of positions generated by in3 from our start position


-- in3 start = return start >>= moveKnight >>= moveKnight >>= moveKnight 

-- TRY TO MAKE THE ABOVE WORK #QUESTION
